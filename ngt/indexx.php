...
<div class="container">
  ...
  <header>
    ...
    <nav> <li><a href="#0"><span>Admin></a></li> 
          ...
          <li><a href="content/siswa.php"><span>Data Siswa </span></a></li>
		      <li><a href="content/jurusan.php"><span>Jurusan </span></a></li>
		      <li><a href="logout.php"><span>Log out</span></a></li>
  </header>
  <div class="main"> <img id="hero" src="lingkungansekolah.jpg" alt="" />
    <article>
      <h3>Selamat Datang di Aplikasi Pendaftaran Siswa Baru SMKN 1 Kampung Baru</h3>
...
<p> Anda Login Sebagai Administrator
</p>
  </article>
  </div>
</div>
